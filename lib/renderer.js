...
class GravissRenderer {
  ...
  // every contour vertex equals its fill vertex to the bit. Drawn after the
  // fill, the ties pass and the arrises sit on the member; drawn before the
  // shell fill, anything the slab strictly hides is covered, to the exact
  // intersection.
