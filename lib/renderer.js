...
class GravissRenderer {
  ...
  memberPlacement(elements) {
    ...
    const placement = { matrices, segmentToEntityIndex, entityRanges, elements, count };
  ...
  addMemberInstances(unit, placement, elements, memberGroup, colorKey) {
    const THREE = this.THREE;
    const mesh = new THREE.InstancedMesh(unit.clone(), this.memberMaterial, placement.count);
