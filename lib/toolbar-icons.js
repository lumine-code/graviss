const ICON_DRAWINGS = Object.freeze({
  ...
  "detail-axis": `
    ...
    <circle cx="4.2" cy="15.8" r="1.7" fill="currentColor" stroke="none"></circle>
    <circle cx="15.8" cy="4.2" r="1.7" fill="currentColor" stroke="none"></circle>
  `,
  "detail-section": `
  ...
  `,
  "detail-full": `
    <path class="graviss-icon-fill" d="m4.6 13.4 8.8-8.8 2 2-8.8 8.8-2-2Z"></path>
    <path d="m4.6 13.4 8.8-8.8 2 2-8.8 8.8-2-2ZM6.6 15.4l1.4 1.4 8.8-8.8-1.4-1.4"></path>
  `,
  background: `
