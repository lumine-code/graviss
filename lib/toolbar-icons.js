const ICON_DRAWINGS = Object.freeze({
  ...
  `,
  "add-graphic": `
    <rect x="5" y="3.5" width="10" height="13" rx="1.2"></rect>
    <path d="M10 7v6M7 10h6"></path>
  `,
  "delete-graphic": `
    <rect x="5" y="3.5" width="10" height="13" rx="1.2"></rect>
    <path d="m7.8 7.8 4.4 4.4M12.2 7.8l-4.4 4.4"></path>
  `,
  fit: `
  ...
  `,
  gradient: `
    <rect x="3" y="3" width="14" height="14" rx="2" class="graviss-icon-fill"/>
    <rect x="3" y="3" width="14" height="14" rx="2" fill="none" stroke="currentColor" stroke-width="1.5"/>
    <path d="M4.5 6.5h11M4.5 9h11M4.5 11.5h11M4.5 14h11" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" opacity="0.55"/>
  `,
  springs: `
    <path d="M2 10h3l2-6 3 12 3-9 1.5 3H18" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round"/>
  `,
  couplings: `
    <path d="M4 4v12M16 4v12M4 10h12" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
  ...
  `,
  "save-image": `
    <path d="M4.4 3.4h8.4L16.6 7v9.6a1 1 0 0 1-1 1H4.4a1 1 0 0 1-1-1V4.4a1 1 0 0 1 1-1Z"></path>
    <path d="M6.6 3.4v4.2h6V3.4M6.6 17.6v-5.2h6.8v5.2"></path>
  `,
  "copy-image": `
    <rect x="3.2" y="3.2" width="10.2" height="10.2" rx="1.2"></rect>
    <path d="M6.6 16.8h9a1.2 1.2 0 0 0 1.2-1.2v-9"></path>
    <path d="M3.2 10.6 6 7.9l2.2 2.1 2.4-2.6 2.8 3.3"></path>
    <circle cx="6.4" cy="6.3" r="1.1"></circle>
  `,
  "open-source": `
    <path d="M11 3.2H5.6a1.4 1.4 0 0 0-1.4 1.4v10.8a1.4 1.4 0 0 0 1.4 1.4h8.8a1.4 1.4 0 0 0 1.4-1.4V8.2z"></path>
    <path d="M11 3.2v3.6a1.4 1.4 0 0 0 1.4 1.4h3.4"></path>
    <path d="m9 10.9-1.7 1.8L9 14.5M11.8 10.9l1.7 1.8-1.7 1.8"></path>
  `,
  "filter-panel": `
    <path d="M3.2 4.2h13.6l-5.2 6v5.6l-3.2 1.4v-7z"></path>
  `,
  "results-panel": `
    <path d="M3 3.6v12.8"></path>
    <path d="M3 6.2h13.8"></path>
    <path d="M3 6.2c5.6 0 10.4 3.6 13.8 9.6"></path>
  `,
  background: `
